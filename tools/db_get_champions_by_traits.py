    ...
    try:
        ...
        if not traits:
            return {
                ...
                "internal_info": {"function_name": "db_get_champions_by_traits", "parameters": {"traits": traits, "limit": limit}},
            }
        ...
        power_stats = {"highest": highest_power, "lowest": lowest_power, "average": round(average_power, 1)}
