    ...
    try:
        ...
        if results:
            ...
            return {
                ...
                "internal_info": {"function_name": "db_get_random_greetings", "parameters": {}},
            }
        else:
            ...
            return {
                ...
                "content": {"greeting": "Greetings, cadet. T-3RN at your service."},
                "internal_info": {"function_name": "db_get_random_greetings", "parameters": {}, "fallback": True},
            }
        ...
        return {
            ...
            "content": {"greeting": "Greetings, cadet. T-3RN at your service."},
            "internal_info": {"function_name": "get_random_greetings", "parameters": {}, "error": str(e), "fallback": True},
        }
